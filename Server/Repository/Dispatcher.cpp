...
void CommunicatorDispatcher::ProcessMsg()
{
	...
	while (true)
	{
		...
		if (msg.GetCommand() == "reply" || msg.GetCommand() == "reply_download" || msg.GetCommand() == "reply_files" || msg.GetCommand() == "reply_simi" || msg.GetCommand() == "reply_search" || msg.GetCommand() == "reply_upload")
		{
